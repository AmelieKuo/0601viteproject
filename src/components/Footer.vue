<template>
    <!-- footer -->
    <footer class="h-full col-start-1 col-end-3 row-start-3 row-end-4 lg:col-start-2 bg-[#00000] bg-opacity-40 backdrop-blur-[20px] p-[24px_40px] flex flex-col justify-around md:flex-row md:gap-24px md:items-center lg:p-[0px_40px] ">
        <div class="max-h-100% box-border md:w-50% md:flex md:flex-col md:justify-center md:h-100%">
